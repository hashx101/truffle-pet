...
var blockchainLifecycle = new dev_utils_1.BlockchainLifecycle();
...
describe('EtherTokenWrapper', function () {
    ...
    describe('#getContractAddressIfExists', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            it('should return undefined if connected to an unknown network', function () {
                var UNKNOWN_NETWORK_NETWORK_ID = 10;
                var unknownNetworkZeroEx = new src_1.ZeroEx(web3.currentProvider, { networkId: UNKNOWN_NETWORK_NETWORK_ID });
                var contractAddressIfExists = unknownNetworkZeroEx.etherToken.getContractAddressIfExists();
