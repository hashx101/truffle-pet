...
var ExchangeWrapper = /** @class */ (function (_super) {
    ...
    ExchangeWrapper.prototype.fillOrdersUpToAsync = function (signedOrders, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress, orderTransactionOpts) {
        if (orderTransactionOpts === void 0) { orderTransactionOpts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var takerTokenAddresses, exchangeContractAddresses, shouldValidate, filledTakerTokenAmount, zrxTokenAddress, exchangeTradeEmulator, _i, signedOrders_1, signedOrder, singleFilledTakerTokenAmount, orderAddressesValuesAndSignatureArray, _a, orderAddressesArray, orderValuesArray, vArray, rArray, sArray, exchangeInstance, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._orderValidationUtils.validateFillOrderThrowIfInvalidAsync(exchangeTradeEmulator, signedOrder, fillTakerTokenAmount.minus(filledTakerTokenAmount), takerAddress, zrxTokenAddress)];
                    case 3:
     ...
     */
    ExchangeWrapper.prototype._unsubscribeAll = function () {
